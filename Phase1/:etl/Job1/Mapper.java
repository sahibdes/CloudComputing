...
public class Mapper {
	...
	public static void main(String[] args) throws IOException {
		...
		BufferedReader bfr2 = new BufferedReader(new InputStreamReader(
				ClassLoader.getSystemResourceAsStream("banned.txt")));
		...
		BufferedReader bfr1;
		bfr1 = new BufferedReader(new InputStreamReader(
				ClassLoader.getSystemResourceAsStream("afinn.txt")));
		...
		if (!tweet.isEmpty()) {
			...
			String tweet_id_text_score = tweetMap.get("id_str").getAsString()
					...
					+ URLEncoder.encode(tweetMap.get("tweet_text")
							.getAsString(), "UTF-8") + "sahibpaswati" + tweetScore;
